...
public class GetParametros {
	...
	/**
	 * DEFINI O MAPA DE PARAMETROS PARA EXECUCAO DO ROBO RbCancelaProcOciosos
	 * @param LOGGER
	...
	public void setParamExecEtpGen(Logger LOGGER, Map<String, String> paramExecEtpGen) {
		try {
			...
			this.paramExecEtpGen  = Funcoes.getParametrosLecom(LOGGER, pathGen + "/RbCancelaProcOciosos.properties");
		} catch (Exception e) {
